...
ini_c <- 2504 # size of the initial birth cohorts of the model (affects computation times - 50 takes 10-15 minutes, but should be closer to 1000 for smooth results)
...
weights <- c(asfr = 0.2,
             ...
             unwanted = 0.0,
             desired = 0.0,
             ccf_edu = 0.8) # weights for the computation of the MSE
