...
ini_c <- 2500
param <- post[order(post$mse),!names(post)%in%c("mse", "modName")][2,]
...
saveRDS(t_out$simDat, file.path(st_dir, "sim_trajectories_p2.rds"))
...
# simulated data 
sim_dat <- readRDS(file.path(st_dir, "sim_trajectories_p2.rds"))
